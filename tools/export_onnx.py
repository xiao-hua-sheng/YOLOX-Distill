...
def make_parser():
    ...
    parser.add_argument(
        "--output-name", type=str, default="../my_model/2022_06_06_YOLOXMS_640.onnx", help="output name of models"
    )
    parser.add_argument(
    ...
    parser.add_argument("--no-onnxsim", default=True,action="store_true", help="use onnxsim or not")
    parser.add_argument(
        "-f",
        "--exp_file",
