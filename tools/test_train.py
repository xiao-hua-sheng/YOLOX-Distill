...
from exps.example.yolox_voc.test_yolox_voc_s import TestExp
...
if __name__ == "__main__":
    ...
    # learn_ratio = [0.04/batch_size,0.02/batch_size,0.01/batch_size,0.005/batch_size,0.0025/batch_size]
    #mixups = [False,True]
    no_aug = [5,10,15,20,25,30]
    for i,mp in enumerate(no_aug):
        args.experiment_name = 'test/no_aug_epochs_model%d'%i
        exp = TestExp()
        exp.no_aug_epochs = mp
        exp.merge(args.opts)
