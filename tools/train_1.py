...
def make_parser():
    ...
    parser.add_argument("-expn", "--experiment-name", type=str, default='20220420/model1_320_datav2')
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="/home/zhangjian/YOLOX/exps/example/yolox_voc/yolox_voc_s_2.py",
        type=str,
